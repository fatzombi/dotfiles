...
vim.keymap.set("n", "<leader>oo", ":cd /Users/fatzombi/Documents/Obsidian\\ Vault<cr>")
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"/Users/fatzombi/Documents/Obsidian\\ Vault\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"/Users/fatzombi/Documents/Obsidian\\ Vault\"}<cr>")

-- Performing our weekly review
-- move file in current buffer to zettelkasten folder
--vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /Users/fatzombi/Documents/Obsidian\\ Vault\zettlekasten<cr>:bd<cr>")
